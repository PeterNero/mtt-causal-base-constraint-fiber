...
def main() -> None:
    ...
    run(sys.executable, "build_q79_eta9_graph_tangent_single_fiber_rank.py")
    run(sys.executable, "verify_q79_eta9_graph_tangent_single_fiber_rank.py")
    run(sys.executable, "build_q79_eta9_graph_tangent_multifiber_observability.py")
    run(sys.executable, "verify_q79_eta9_graph_tangent_multifiber_observability.py")
    run(sys.executable, "build_q79_eta9_physical_midpoint_three_evaluation_frame.py")
    run(sys.executable, "verify_q79_eta9_physical_midpoint_three_evaluation_frame.py")
    run(sys.executable, "build_q79_eta9_physical_canonical_dual_response_observability.py")
    run(sys.executable, "verify_q79_eta9_physical_canonical_dual_response_observability.py")
